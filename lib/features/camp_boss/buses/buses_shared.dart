...
class BusesPalette {
  ...
  static const secondary = AppPalette.purple;
...
/// 🔍 شريط بحث Buses
class BusesSearchBar extends StatefulWidget {
  final String hint;
  final String value;
  final ValueChanged<String> onChanged;
  final IconData? icon;

  const BusesSearchBar({
    super.key,
    required this.hint,
    required this.value,
  ...
  @override
  State<BusesSearchBar> createState() => _BusesSearchBarState();
}

class _BusesSearchBarState extends State<BusesSearchBar> {
  ...
  @override
  void didUpdateWidget(covariant BusesSearchBar oldWidget) {
...
/// 🏷️ شريحة فلتر
class BusesFilterChip extends StatelessWidget {
  final String label;
  final int count;
  final bool selected;
  final Color color;
...
/// 📭 حالة فارغة
class BusesEmpty extends StatelessWidget {
  final IconData icon;
  final String title;
...
bool busesMatchesQuery(String query, List<String> fields) {
...
/// أسماء الأيام
List<String> dayNames(bool isAr) => isAr
