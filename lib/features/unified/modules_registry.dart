...
class ModulesRegistry {
  ...
  static List<AppModule> all() => [
        ...
        // ─── 🔧 لَوحات تَشغيليّة (Operational Dashboards) ───
        AppModule(
          key: 'smart_alerts',
          ...
          category: ModuleCategory.reports,
          groupKey: 'dashboards',
          groupTitleAr: '🔧 لَوحات تَشغيليّة',
          groupTitleEn: '🔧 Operational Dashboards',
        ...
        // ─── 📋 تَقارير الامتِثال (Compliance Reports) ───
        AppModule(
          ...
          category: ModuleCategory.reports,
          groupKey: 'compliance',
          groupTitleAr: '📋 تَقارير الامتِثال',
          groupTitleEn: '📋 Compliance Reports',
